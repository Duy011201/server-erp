...
export const getAllStore = (req, res) => {
    const queryCondition = `SELECT st.maKho as id, st.loaiKho, st.tenKho, st.diaChi, st.trangThai
                            FROM ${constant.tableNameBD.STORES} as st`;
    let querySearch = "";
...
export const getAllProduct = (req, res) => {
    const queryCondition =
        `SELECT pd.maSP as id,
                ...
                pd.gia,
                sp.tenKho
         FROM ${constant.tableNameBD.PRODUCTS} as pd` +
...
export const getProductByID = (req, res) => {
    const queryCondition = `SELECT pd.maSP as id, pd.tenSP, pd.loaiSP, pd.donViTinh, pd.soLuong, pd.maKho, pd.gia
                            FROM ${constant.tableNameBD.PRODUCTS} as pd`;
    const data = {
        maSP: req.query.id,
    };
...
export const getAllMaterial = (req, res) => {
    const queryCondition = `SELECT mt.maNVL as id, mt.tenNVL, mt.donViTinh, mt.soLuong, mt.maKho, mt.gia
                            FROM ${constant.tableNameBD.MATERIALS} as mt`;
    let querySearch = "";
...
export const getAllWarehouseReceipt = (req, res) => {
    const queryCondition = `SELECT pn.maPN as id, pn.maNV, pn.ngayNhap, pn.loaiHang, pn.ghiChu
                            FROM ${constant.tableNameBD.WAREHOUSE_RECEIPTS} as pn`;
    let querySearch = "";
...
export const getAllWarehouseReceiptDetail = (req, res) => {
    const queryCondition = `SELECT ctpn.maCTPN as id, ctpn.maPN, ctpn.maSP, ctpn.maNVL, ctpn.soLuong, ctpn.ghiChu
                            FROM ${constant.tableNameBD.WAREHOUSE_RECEIPT_DETAILS} as ctpn`;
    let querySearch = "";
...
export const checkLogin = (req, res) => {
    const queryCondition =
        `SELECT ac.maTK as id, ac.tenTK, ac.maQuyen, rl.quyen
         FROM ${constant.tableNameBD.ACCOUNTS} as ac` +
...
export const getEmployeeByID = (req, res) => {
    const queryCondition = `SELECT nv.maNV as id,
                                   nv.hoTen,
                                   nv.soCCCD,
                                   nv.diaChi,
                                   nv.gioiTinh,
                                   nv.maChucVu,
                                   nv.maPhongBan
                            FROM ${constant.tableNameBD.EMPLOYEES} as nv`;
    const data = {
        maNV: req.query.id,
    };
    return getByID(
...
export const getAllEmployee = (req, res) => {
    let queryCondition = `SELECT nv.maNV as id,
                                 nv.hoTen,
                                 nv.gioiTinh,
                                 nv.ngaySinh,
                                 nv.diaChi,
...
export const getRewardDisciplineByID = (req, res) => {
    let queryCondition = `SELECT ktkl.maKTKL as id, nv.hoTen, ktkl.maNV, ktkl.hinhThuc, ktkl.lyDo, ktkl.ngayKTKL
                          FROM ${constant.tableNameBD.REWARD_DISCIPLINES} as ktkl`;
...
export const getAllRewardDiscipline = (req, res) => {
    let queryCondition = `SELECT ktkl.maKTKL as id, ktkl.maNV, ktkl.hinhThuc, ktkl.lyDo, ktkl.ngayKTKL, nv.hoTen
                          FROM ${constant.tableNameBD.REWARD_DISCIPLINES} as ktkl`;
    queryCondition += ` INNER JOIN ${constant.tableNameBD.EMPLOYEES} as nv ON nv.maNV = ktkl.maNV`;
    let querySearch = "";
...
export const getAllPosition = (req, res) => {
    const queryCondition = `SELECT dp.maChucVu as id, dp.tenChucVu, dp.trangThai, dp.maPhongBan
                            FROM ${constant.tableNameBD.POSITIONS} as dp`;
    let querySearch = "";
...
export const getPositionByID = (req, res) => {
    const queryCondition = ``;
    return getByID(req, res, constant.tableNameBD.POSITIONS, queryCondition);
};
...
export const deletePositionByID = (req, res) => {
    ...
    return deleteByID(req, res, constant.tableNameBD.POSITIONS, deleteColumns);
};
...
export const createPosition = (req, res) => {
    ...
    return create(req, res, constant.tableNameBD.POSITIONS, newPosition);
};

// Department
export const getAllDepartment = (req, res) => {
    const queryCondition = `SELECT ps.maPhongBan as id, ps.tenPhongBan, ps.diaChi, ps.soDienThoai, ps.email
                            FROM ${constant.tableNameBD.DEPARTMENTS} as ps`;
    let querySearch = "";
...
export const getDepartmentByID = (req, res) => {
    const queryCondition = ``;
    return getByID(req, res, constant.tableNameBD.DEPARTMENTS, queryCondition);
};
...
export const deleteDepartmentByID = (req, res) => {
    ...
    return deleteByID(req, res, constant.tableNameBD.DEPARTMENTS, deleteColumns);
};
...
export const createDepartment = (req, res) => {
    ...
    return create(req, res, constant.tableNameBD.DEPARTMENTS, newDepartment);
};

// Warehouse exports
export const getAllWarehouseExport = (req, res) => {
    const queryCondition = `SELECT px.maPX as id, px.maNV, px.ngayXuat, px.loaiHang, px.ghiChu
                            FROM ${constant.tableNameBD.WAREHOUSE_EXPORTS} as px`;
    let querySearch = "";
...
export const getAllWarehouseExportDetail = (req, res) => {
    const queryCondition = `SELECT ctpx.maCTPX as id, ctpx.maPX, ctpx.maSP, ctpx.maNVL, ctpx.soLuong, ctpx.ghiChu
                            FROM ${constant.tableNameBD.WAREHOUSE_EXPORT_DETAILS} as ctpx`;
...
=======
    const queryCondition = `SELECT wp.maQTCT as id, wp.maNV, wp.maCV, wp.ngayBatDau, wp.ngayKetThuc, wp.danhGia
                            FROM ${constant.tableNameBD.WORKING_PROCESS} as wp`;
    let querySearch = "";
    if (
        req.body.workingprocessExportID &&
        req.body.workingprocessExportID !== ""
    ) {
        querySearch += ` WHERE wp.maQTCT = ${req.body.workingprocessExportID}`;
    }
>>>>>>> 5bedc93d6175baa6e61c8654319c91035a665cdc
...
// Report
export const getAllReportReceipt = (req, res) => {
    let queryCondition = `SELECT *
                          FROM ${constant.tableNameBD.WAREHOUSE_RECEIPTS} as wr`;
    queryCondition += ` INNER JOIN ${constant.tableNameBD.WAREHOUSE_RECEIPT_DETAILS} as wrd ON wrd.maPN = wr.maPN`;
    let querySearch = "";
    return getAll(
        res,
        constant.tableNameBD.WAREHOUSE_RECEIPTS,
...
export const getAllReportExport = (req, res) => {
    let queryCondition = `SELECT *
                          FROM ${constant.tableNameBD.WAREHOUSE_EXPORTS} as we`;
    queryCondition += ` INNER JOIN ${constant.tableNameBD.WAREHOUSE_EXPORT_DETAILS} as wed ON wed.maPX = we.maPX`;
    let querySearch = "";
    return getAll(
        res,
        constant.tableNameBD.WORKING_PROCESS,
